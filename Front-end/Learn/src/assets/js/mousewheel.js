    ...
    var t,
      ...
      _ = function () {
        ...
        if (n.advanced.autoExpandHorizontalScroll && "y" !== n.axis) {
          ...
          3 === n.advanced.autoExpandHorizontalScroll ||
            ...
            .css({
              width: Math.ceil(i[0].getBoundingClientRect().right + 0.4) -
      ...
      G = function (t, o, n) {
        ...
        var s = t.data(a),
          ...
          Y.call(t, c.callbacks.onTotalScrollOffset) : [0, 0],
          g = c.callbacks.onTotalScrollBackOffset ?
          Y.call(t, c.callbacks.onTotalScrollBackOffset) : [0, 0];
        if (
          ((s.trigger = n.trigger),
